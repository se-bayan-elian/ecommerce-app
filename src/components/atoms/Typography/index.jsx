...
const Typography = ({ as, variant, align = "left", children , ...props }) => {
  ...
  switch (as.toLowerCase()) {
    case "h1":
      return (
        <StyledH1 variant={variant} align={align}>
          {children}
        </StyledH1>
      );
    case "h2":
      return (
        <StyledH2 variant={variant} align={align}>
          {children}
        </StyledH2>
      );
    case "h3":
      return (
        <StyledH3 variant={variant} align={align}>
          {children}
        </StyledH3>
      );
    case "h4":
      return (
        <StyledH4 variant={variant} align={align}>
          {children}
        </StyledH4>
      );
    case "h5":
      return (
        <StyledH5 variant={variant} align={align}>
          {children}
        </StyledH5>
      );
    case "h6":
      return (
        <StyledH6 variant={variant} align={align}>
          {children}
        </StyledH6>
      );
    // variant for p 
    ...
    case "p" :
      return <StyledP variant={variant} align={align}>{children}</StyledP>
      default : 
